...
import image2 from '../product_img/product_img2.webp'
import image3 from '../product_img/product_img3.webp'
import image4 from '../product_img/product_img4.webp'
import image5 from '../product_img/product_img5.webp'
import image6 from '../product_img/product_img6.webp'
import image7 from '../product_img/product_img7.webp'
import image8 from '../product_img/product_img8.webp'
import image9 from '../product_img/product_img9.webp'
import image10 from '../product_img/product_img10.webp'
import image11 from '../product_img/product_img11.webp'
import image12 from '../product_img/product_img12.webp'
import image13 from '../product_img/product_img13.webp'
import image14 from '../product_img/product_img14.webp'
import image15 from '../product_img/product_img15.webp'
  ...
  return (
    <>
        <div className="product_main">
          <div className="product_left">
            <div className="product_text">
              <ul className='ul1'>
                <li><NavLink to="/">Home</NavLink>&nbsp;&nbsp;<i class="bi bi-chevron-right"></i> All Product</li>
              </ul>
              <ul className='ul2'>
                <li>Browse by</li>
                <hr />
              </ul>
              <ul className={`ul3 ${active === 0 ? `active` : ""}`}>
            ...
            <div className="product_right_img">
              <div className="product_right_container1">
                <div className="product_right_top">
                  <NavLink><img src={image1} alt="" /></NavLink>
                </div>
        ...
        {/* End */}
         ...
         {/* product_right_page 4 */}
        {/* Start */}

        <div className="product_right_04">
            <div className="product_right_img">
              <div className="product_right_container1">
                <div className="product_right_top">
                  <NavLink><img src={image10} alt="" /></NavLink>
                </div>
                <div className="product_right_bottom">
                  <h1>Gameflow Black</h1>
                  <h3><del>$1,000.00</del>$900.00</h3>
              ...
              <div className="product_right_container1">
                <div className="product_right_top">
                  <NavLink><img src={image11} alt="" /></NavLink>
                </div>
                <div className="product_right_bottom">
                  <h1>Playbox XZ Gold Edition</h1>
                  <h3>$1,000.00</h3>
              ...
              <div className="product_right_container1">
                <div className="product_right_top">
                  <NavLink><img src={image12} alt="" /></NavLink>
                </div>
                <div className="product_right_bottom">
                  <h1>L503 Headset</h1>
                  <h3><del>$29.99</del>$26.99</h3>
        ...
        {/* End */}
         ...
         {/* product_right_page 5 */}
        {/* Start */}

        <div className="product_right_05">
            <div className="product_right_img">
              <div className="product_right_container1">
                <div className="product_right_top">
                  <NavLink><img src={image13} alt="" /></NavLink>
                </div>
                <div className="product_right_bottom">
                  <h1>Gameflow Black</h1>
                  <h3><del>$1,000.00</del>$900.00</h3>
              ...
              <div className="product_right_container1">
                <div className="product_right_top">
                  <NavLink><img src={image14} alt="" /></NavLink>
                </div>
                <div className="product_right_bottom">
                  <h1>Playbox XZ Gold Edition</h1>
                  <h3>$1,000.00</h3>
              ...
              <div className="product_right_container1">
                <div className="product_right_top">
                  <NavLink><img src={image15} alt="" /></NavLink>
                </div>
                <div className="product_right_bottom">
                  <h1>L503 Headset</h1>
                  <h3><del>$29.99</del>$26.99</h3>
